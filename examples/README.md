...
- `claude_desktop_config.json` — stdio MCP config for Claude Desktop.
- `cursor_mcp.json` — stdio MCP config for Cursor.

See [../docs/BUILD_BRIEF.md §11](../docs/BUILD_BRIEF.md#11-install--cross-client-setup)
for the full install and cross-client setup plan.
